# Deploy paper-time (Frontend + Backend) — Free Tier
...
3. Connect your GitHub account if needed, then select your **paper-time** repo.
4. Use these settings:

| Field | Value |
|-------|--------|
| **Name** | `paper-time-api` (or any name) |
...
```text
https://paper-time-api.onrender.com
```
...
| Name | Value |
|------|--------|
| `NEXT_PUBLIC_API_URL` | `https://paper-time-api.onrender.com` |
...
```text
https://paper-time-xxx.vercel.app
```
