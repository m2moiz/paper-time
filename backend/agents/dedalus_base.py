...
# Sponsor model chains.
# The Dedalus gateway routes the bare model strings below to the corresponding
# sponsor provider. Per-agent task type controls which chain is used so that
# heavier reasoning lands on Kimi K2.6 while quick analysis can fall back to
# GLM-4.6 or DeepSeek for cost/latency tuning.
#
# Override at runtime via the MODEL_OVERRIDE_<TASK> env vars (see README).
MODEL_CHAINS: dict[TaskType, list[str]] = {
    # Research: GLM-4.6 quick scan → Kimi K2.6 synthesises
    "research": [
        "zhipuai/glm-4.6",
        "moonshotai/kimi-k2-instruct",
    ],

    # Code generation: Kimi K2.6 plans and implements
    "code": ["moonshotai/kimi-k2-instruct"],

    # Creative writing (narration scripts, persona prompts): Kimi K2.6
    "creative": ["moonshotai/kimi-k2-instruct"],

    # Analysis: GLM-4.6 for quick parse → Kimi K2.6 for deep reasoning
    "analysis": [
        "zhipuai/glm-4.6",
        "moonshotai/kimi-k2-instruct",
    ],

    # Multi-step complex tasks: long-context fallback via DeepSeek when needed
    "multi_step": [
        "moonshotai/kimi-k2-instruct",
