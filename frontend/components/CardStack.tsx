    ...
    <div>
      ...
      >
        ...
        <div className="sticky top-0 h-screen overflow-hidden">
          ...
          >
            <div className="flex items-center gap-2.5 rounded-full bg-[var(--paper-cream-deep)] px-4 py-2 border-2 border-[var(--pencil-gray)] shadow-[2px_2px_0_0_var(--pencil-gray)]">
                ...
                {sections.map((_, i) => (
                  <div
                    ...
                    className={cn(
                      ...
                      i === activeIndex
                        ? "w-4 bg-[var(--accent-coral)]"
                        : i < activeIndex
                          ? "w-1 bg-[var(--pencil-gray)]"
                          : "w-1.5 bg-[var(--pencil-gray)]/50"
                    )}
                  />
                ))}
              </div>
      ...
      >
        <div className="flex items-center gap-3 w-full max-w-3xl mx-auto text-sm text-[var(--ink-muted)] px-6">
          <div className="h-px flex-1 bg-gradient-to-r from-transparent to-[var(--pencil-gray)]" />
          <span>End of paper</span>
          <div className="h-px flex-1 bg-gradient-to-l from-transparent to-[var(--pencil-gray)]" />
        </div>

        <button
          onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}
          className="mt-2 text-xs text-[var(--ink-muted)] hover:text-[var(--ink-black)] transition-colors"
        >
          Back to top
        </button>
      </motion.div>
